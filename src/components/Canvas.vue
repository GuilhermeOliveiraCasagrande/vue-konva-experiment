  ...
  <div>
    <div>
      <label>
        ...
        <button v-on:click="onUpload">Add Image</button>
      </label>
    </div>
    <div>
      <label>
        <button v-on:click="onDownload">Edited Image Download</button>
      </label>
    </div>
    <div>
      <v-stage
        style="width:350px; height:350px; border: 2px solid #000000;"
        ref="stage"
        :config="stageSize"
